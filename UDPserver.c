...
void sendRandomNumbers(char *buffer, int number_of_bytes_send, int number_of_bytes_received, int internet_socket, struct sockaddr_storage client_internet_address, int client_internet_address_length);
...
void execution( int internet_socket )
{
	...
	else
	{
		...
		if (go == true)
		{
			sendRandomNumbers(buffer,number_of_bytes_send, number_of_bytes_received, internet_socket, client_internet_address, client_internet_address_length);
